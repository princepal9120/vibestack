    ...
    if (isYouTube) {
        return (
            <motion.div
                ...
                whileHover={{ y: -4 }}
                className={cn(
                    "group relative block overflow-hidden rounded-xl border border-border bg-card transition-all hover:shadow-lg hover:border-primary/30",
                    className
                )}
            >
                <a href={resource.url} target="_blank" rel="noopener noreferrer" className="block">
                    ...
                    <div className="relative aspect-video bg-muted overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-12 h-12 rounded-full bg-red-500/90 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                        ...
                        <div className="absolute top-2 right-2">
                            <span className="inline-flex items-center gap-1 rounded-md bg-black/60 backdrop-blur px-2 py-1 text-xs font-medium text-white">
